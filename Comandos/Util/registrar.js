...
module.exports = {
    ...
    run: async (client, interaction) => {
        if(!interaction.member.permissions.has(Discord.PermissionFlagsBits.Administrator)){
            interaction.reply({content: `Olá ${interaction.user}, este comando não está configurado no momento. Converse com o dono do servidor para mais informações!`})
        } else {
            interaction.reply({content: `Olá ${interaction.user}, este comando não está disponível no momento.`})
        }
        // const roles = {
