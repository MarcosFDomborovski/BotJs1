...
//                                 } else {
//                                     // MODAL
//                                     if (selectedItem.customId === 'mute_membro5' || selectedItem.customId === 'mute_membro10' || selectedItem.customId === 'disconnect_membro' || selectedItem.customId === 'deafen_membro' || selectedItem.customId === 'troca_cargo') {
...
//                                             .setAuthor({ name: interaction.guild.name, iconURL: interaction.guild.iconURL({ dynamic: true }) })
//                                             .setTitle('✅ Compra Efetuada! ✅')
//                                             .setDescription(`Olá ${member}, o usuário [${interaction.user}] comprou **${selectedItem.nome}**!\n**_Lembre-se de enviar para ele!_**`)
//                                             .setFooter({ text: 'Data da compra:' })
//                                             .setTimestamp(Date.now())
